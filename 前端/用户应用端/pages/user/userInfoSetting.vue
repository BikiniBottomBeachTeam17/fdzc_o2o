			...
			<view class="infoAll">
				<u-cell-group :border="false">
					<u-cell :border="false" title="头像" :isLink="true">
						<avatar selWidth="200rpx" selHeight="200rpx" :avatarSrc="tempAvarter"
							@upload="avatarUpload" avatarStyle="width: 100rpx; height: 100rpx;border: 1px solid #000;"
							inner="true" style="margin: 0 auto;width: 100rpx;height: 100rpx;" slot='value'></avatar>
					</u-cell>
					<u-cell :border="false" title="账号">
						<text slot="value">{{userInfo.userAccount}}</text>
					</u-cell>
					<u-cell :border="false" title="昵称" :isLink="true">
					...
					<u-cell :border="false" title="电子邮箱" :isLink="true">
						<text slot="value">{{userInfo.userEmail!=null?userInfo.userEmail:'设置电子邮箱'}}</text>
					</u-cell>
					<u-cell :border="false" title="联系方式" :isLink="true">
